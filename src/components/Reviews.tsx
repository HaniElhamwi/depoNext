...
//       setFormData({ name: "", department: "", year: "", review: "", rating: 0 });
//       setShowForm(false);
//       fetchReviews(); // تحديث القائمة بعد الإرسال
//     } catch (error) {
...
//               className="max-w-xl mx-auto mt-6 bg-white p-6 rounded-xl shadow-md space-y-4"
//             >
//               <input
//                 type="text"
//                 placeholder="Name"
...
//               <Button
//                 type="submit"
//                 className="bg-ssu-blue hover:bg-ssu-blue/90 w-full"
//               >
//                 Submit
//               </Button>
//             </form>
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4 max-w-2xl">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              />
              <Button type="submit" className="bg-ssu-blue hover:bg-ssu-blue/90">
                Submit
              </Button>
            </form>
          </div>
